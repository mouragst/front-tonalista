...
const ModalResumoEvento = ({ isModalOpen, onClose }) => {
          ...
          {activeTab === 1 && (
            ...
            <div className="mb-4">
              ...
              <div className="flex items-center justify-center w-full">
                <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-80 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-100 hover:bg-gray-200 ">
...
export default ModalResumoEvento;