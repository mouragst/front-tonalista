...
function Eventos() {
  ...
  const emAndamentoCount = 0, concluidoCount = 0, canceladoCount = 0;
      ...
      <div className="flex-grow p-4 text-black bg-gray-200">
        ...
        <div className="flex space-x-4 mb-3">
          ...
          <div className="relative mr-12">
              <button
                  className={`px-4 py-2 mr-6 rounded ${activeTab === 'Concluido' ? 'bg-green-500 text-white' : 'bg-gray-300 hover:bg-green-500 hover:text-white text-black'}`}
                  onClick={() => setActiveTab('Concluido')}
              >
                  Concluídos
              </button>
              <span className="absolute mr-6 bottom-0 right-0 transform translate-x-1/2 translate-y-1/2 bg-green-800 text-white text-xs rounded-full px-2 py-1">
            ...
            return (
              <div key={index} className="bg-white shadow-md rounded-lg p-4 h-full min-h-[600px] flex flex-col justify-between">
                ...
                <div className="flex flex-col space-y-2 mt-auto">
                  <button className="bg-sky-500 hover:bg-sky-600 text-white px-4 py-2 rounded">Ver Evento Detalhado</button>
                  <button className="bg-green-500 hover:bg-i-600 text-white px-4 py-2 rounded">Ver Resumo do Evento</button>
